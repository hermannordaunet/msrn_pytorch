...
from src.models.utils.exitblock import ErrorExitBlock
...
class Exploding_EE_CNN_Residual(nn.Module):
    def __init__(
        self,
        ...
        super(Exploding_EE_CNN_Residual, self).__init__()
    ...
    def add_exit_block(self, exit_type, total_flops):
        ...
        * total_flops:   the total FLOPs of the counterpart model.
        ...
        self.stages.append(nn.Sequential(*self.layers))
        self.exits.append(
            ErrorExitBlock(self.inplanes, self.num_classes, self.input_shape, exit_type)
        )
